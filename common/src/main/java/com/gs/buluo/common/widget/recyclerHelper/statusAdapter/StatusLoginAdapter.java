...
public class StatusLoginAdapter extends BaseQuickAdapter<EaeEntity, BaseHolder> {


    public StatusLoginAdapter(int layoutResId, @Nullable List<EaeEntity> data) {
    ...
    protected void convert(BaseHolder helper, EaeEntity item) {
        ...
        if (item.bacId != 0) {
            helper.setBackgroundRes(R.id.login_click_view, item.bacId);
        }
